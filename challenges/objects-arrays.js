...
log( tyrannosaurus.weight );

// What was the diet of a velociraptor?
log( velociraptor.diet );

// How long was a stegosaurus?
log( stegosaurus.length );

// What time period did tyrannosaurus live in?
log( tyrannosaurus.period );


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
tyrannosaurus.roar = () => { return 'RAWERSRARARWERSARARARRRR!'; };

log( tyrannosaurus.roar() );
...
const universities = graduates.map( e => e.university );
log( universities.sort() );
...
const contactInfo = graduates.map( e => e.first_name + " " + e.email );
log( contactInfo );
...
const lowCaseAnimalNames = zooAnimals.map( e => e.animal_name.toLowerCase() );
log( lowCaseAnimalNames );
...
*/
const populationTotal = zooAnimals.reduce( (ival, curEl) => ival + curEl.population, 0 );
log( populationTotal );
